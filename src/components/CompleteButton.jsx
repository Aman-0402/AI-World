    ...
    <>
      <button
        ...
        className={`inline-flex items-center gap-2 rounded-full px-5 py-2.5 text-sm font-semibold transition hover:-translate-y-0.5 ${
          completed
            ? 'bg-blue-900 text-white shadow-[0_6px_16px_-4px_rgba(30,58,138,0.5)] hover:bg-blue-950'
            : 'bg-gradient-to-r from-blue-700 to-blue-400 text-white shadow-[0_6px_16px_-4px_rgba(29,78,216,0.5)] hover:shadow-[0_10px_24px_-6px_rgba(29,78,216,0.6)]'
        }`}
      >
        {completed ? (
          <>
      ...
      {celebrating && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 backdrop-blur-sm">
          <Confetti />
          <div className="celebration-pop rounded-3xl border border-blue-100 bg-white px-10 py-8 text-center shadow-[0_20px_60px_-15px_rgba(29,78,216,0.4)]">
