...
export const tasks = [
  ...
  },
  {
    id: 93,
    chapterId: 18,
    title: 'Persona Reality Check',
    question: 'How do you stop an AI-generated persona from becoming a generic imaginary customer?',
    whatToDo: 'Create one customer persona, then improve it by adding evidence, context, and realistic buying behavior.',
    steps: [
      'Step 1 — Choose a simple product such as a cafe, gym, skincare brand, study app, or budget clothing store.',
      'Step 2 — Ask AI to create one customer persona with demographics, goals, pain points, budget, buying triggers, and objections.',
      'Step 3 — Highlight anything that sounds too broad, such as "likes quality products" or "wants good service."',
      'Step 4 — Rewrite the weak parts so they feel specific to your product, location, and customer situation.',
    ],
    requiredFile: null,
    downloadUrl: null,
    whatYouLearn: [
      'How to turn a basic persona into a more realistic marketing profile.',
      'Why specific behavior is more useful than generic personality traits.',
    ],
    questions: [
      'Which part of the first persona sounded most generic?',
      'What specific detail made the improved persona more believable?',
    ],
  },
  {
    id: 94,
    chapterId: 18,
    title: 'Map Pain Points to Messages',
    question: 'How does a customer pain point become a marketing message?',
    whatToDo: 'Use one persona to convert pain points into benefit-focused messages for a product or service.',
    steps: [
      'Step 1 — Use the persona from the previous activity or create a new one.',
      'Step 2 — List 4 pain points the customer has before buying.',
      'Step 3 — Ask AI: "Turn these customer pain points into benefit-focused marketing messages. Keep each message specific, realistic, and not exaggerated."',
      'Step 4 — Pick the best 2 messages and explain which pain point each one solves.',
    ],
    requiredFile: null,
    downloadUrl: null,
    whatYouLearn: [
      'How customer problems connect directly to marketing copy.',
      'Why strong messages talk about benefits instead of only product features.',
    ],
    questions: [
      'Which message best matched a real customer pain point?',
      'Which AI message felt exaggerated or unsupported?',
    ],
  },
  {
    id: 95,
    chapterId: 18,
    title: 'Compare Two Buyer Journeys',
    question: 'Do two customer personas follow the same buying journey?',
    whatToDo: 'Create two different personas for the same product and compare how their buyer journeys differ.',
    steps: [
      'Step 1 — Choose one product and define two different customer types.',
      'Step 2 — Ask AI to map awareness, consideration, decision, and post-purchase stages for both personas.',
      'Step 3 — Compare what each persona needs at each stage.',
      'Step 4 — Identify one channel or content type that would work for one persona but not the other.',
    ],
    requiredFile: null,
    downloadUrl: null,
    whatYouLearn: [
      'How buyer journeys change based on audience motivation and context.',
      'Why one marketing plan rarely fits every customer segment equally well.',
    ],
    questions: [
      'Which stage differed most between the two personas?',
      'What would you change in the campaign for each persona?',
    ],
  },
  {
    id: 96,
    chapterId: 18,
    title: 'Build a Persona-Based Funnel',
    question: 'Can you design a simple funnel that moves one persona from awareness to purchase?',
    whatToDo: 'Create a marketing funnel for one persona with content, offer, objection handling, and follow-up.',
    steps: [
      'Step 1 — Select your strongest persona and one clear product offer.',
      'Step 2 — Ask AI to build a funnel with awareness, consideration, decision, and retention stages.',
      'Step 3 — For each stage, add one message, one channel, one content idea, and one expected customer action.',
      'Step 4 — Review the funnel for gaps: where might the customer lose interest or need more trust?',
    ],
    requiredFile: null,
    downloadUrl: null,
    whatYouLearn: [
      'How personas, buyer journeys, channels, and offers connect into one funnel.',
      'How to use AI as a planning assistant while still checking for weak assumptions.',
    ],
    questions: [
      'Where is your funnel weakest, and why?',
      'What assumption about the customer would you need to verify before using this plan?',
    ],
  },
  {
    id: 97,
    chapterId: 19,
    title: 'Headline Angle Practice',
    question: 'How can the same product be advertised from different angles?',
    whatToDo: 'Generate headlines for one product using problem, benefit, curiosity, and urgency angles.',
    steps: [
      'Step 1 — Choose one product and one target audience.',
      'Step 2 — Ask AI to write 3 headlines each for problem, benefit, curiosity, and urgency angles.',
      'Step 3 — Remove any headline that makes an unsupported claim or sounds too dramatic.',
      'Step 4 — Pick one headline from each angle and explain when you would use it.',
    ],
    requiredFile: null,
    downloadUrl: null,
    whatYouLearn: [
      'How ad angle changes the meaning of a headline.',
      'Why different campaign goals need different headline types.',
    ],
    questions: [
      'Which angle produced the strongest headline?',
      'Which headline needed the most editing before it felt usable?',
    ],
  },
  {
    id: 98,
    chapterId: 19,
    title: 'CTA Strength Test',
    question: 'What makes a call-to-action clear instead of pushy or vague?',
    whatToDo: 'Compare weak and strong CTAs for the same ad and improve them using AI.',
    steps: [
      'Step 1 — Write 5 weak CTAs for a product, such as "Click now" or "Learn more."',
      'Step 2 — Ask AI to rewrite them with clearer action, customer benefit, and lower pressure.',
      'Step 3 — Sort the improved CTAs from softest to strongest.',
      'Step 4 — Choose which CTA fits an awareness ad and which fits a purchase ad.',
    ],
    requiredFile: null,
    downloadUrl: null,
    whatYouLearn: [
      'How CTAs guide the next action in an ad.',
      'How to match CTA intensity to the stage of the customer journey.',
    ],
    questions: [
      'Which CTA felt clearest without being pushy?',
      'Why should awareness ads and purchase ads use different CTAs?',
    ],
  },
  {
    id: 99,
    ...
    question: 'What should you predict before running an A/B test?',
    whatToDo: 'Create two ad versions and write a test hypothesis explaining what you expect to happen and why.',
    steps: [
      'Step 1 — Create Ad A with a practical benefit headline and Ad B with an emotional headline.',
      'Step 2 — Ask AI to help write a hypothesis: which ad should perform better, for which audience, and why.',
      'Step 3 — Define one success metric, such as clicks, sign-ups, enquiries, or purchases.',
      'Step 4 — Identify one reason the winning ad might still not prove the message is better.',
    ],
    requiredFile: null,
    downloadUrl: null,
    whatYouLearn: [
      'How to write a clear A/B testing hypothesis.',
      'Why a test needs a metric and a reason, not just two random ad versions.',
    ],
    questions: [
      'What was your hypothesis before the test?',
      'What metric would decide the winner?',
    ],
  },
  {
    id: 100,
    chapterId: 19,
    title: 'Full Ad Set Review',
    question: 'Can you judge an ad set for clarity, audience fit, and risk before publishing it?',
    whatToDo: 'Build a small ad set and run a structured AI review for message quality and unsupported claims.',
    steps: [
      'Step 1 — Create 3 headlines, 3 short body copies, and 3 CTAs for one campaign.',
      'Step 2 — Ask AI to review the ad set for audience fit, clarity, repetition, tone, and unsupported claims.',
      'Step 3 — Revise the weakest ad using the feedback.',
      'Step 4 — Write a final recommendation explaining which ad you would launch first and what you would test next.',
    ],
    requiredFile: null,
    downloadUrl: null,
    whatYouLearn: [
      'How to evaluate a complete ad set before launch.',
      'How to use AI feedback without accepting every suggestion blindly.',
    ],
    questions: [
      'Which ad did you revise the most, and why?',
      'What claim or phrase did you remove because it was risky?',
    ],
  },
  {
    id: 101,
    chapterId: 20,
    title: 'Campaign Objective Clarity',
    question: 'How does a clear campaign objective change AI\'s marketing plan?',
    whatToDo: 'Compare a vague campaign prompt with a specific objective-driven prompt.',
    steps: [
      'Step 1 — Choose one campaign idea, such as a product launch, admission drive, sale, event, or app launch.',
      'Step 2 — Ask AI for a campaign plan using a vague prompt: "Create a marketing campaign for this product."',
      'Step 3 — Rewrite the prompt with target audience, objective, budget level, timeline, and desired action.',
      'Step 4 — Compare both outputs and identify what improved when the objective became clear.',
    ],
    requiredFile: null,
    downloadUrl: null,
    whatYouLearn: [
      'Why campaign planning starts with a specific objective.',
      'How prompt detail changes the usefulness of AI-generated strategy.',
    ],
    questions: [
      'What was missing from the vague campaign plan?',
      'Which detail in the improved prompt changed the output most?',
    ],
  },
  {
    id: 102,
    ...
    question: 'Which channels deserve attention in a campaign, and which should be ignored?',
    whatToDo: 'Use AI to recommend a channel mix, then challenge whether each channel fits the audience and objective.',
    steps: [
      'Step 1 — Define your campaign audience and objective.',
      'Step 2 — Ask AI to recommend 3 channels to prioritize and 2 channels to deprioritize.',
      'Step 3 — For each recommended channel, write the reason it fits the audience and the campaign goal.',
      'Step 4 — Remove any channel that is popular but not useful for your specific audience.',
    ],
    requiredFile: null,
    downloadUrl: null,
    whatYouLearn: [
      'How to choose marketing channels based on audience behavior and campaign goals.',
      'Why being everywhere is weaker than choosing the right places carefully.',
    ],
    questions: [
      'Which channel did AI suggest that you removed?',
      'What channel best matched your audience, and why?',
    ],
  },
  {
    id: 103,
    chapterId: 20,
    title: 'Message Consistency Across Channels',
    question: 'Can one campaign message stay consistent across different platforms without sounding copied?',
    whatToDo: 'Adapt one campaign message into platform-specific copy for three channels.',
    steps: [
      'Step 1 — Write one core campaign message and one tagline.',
      'Step 2 — Ask AI to adapt the message for Instagram, email, and WhatsApp or LinkedIn.',
      'Step 3 — Check whether each version keeps the same promise while fitting the platform.',
      'Step 4 — Rewrite the weakest version so it sounds natural for that channel.',
    ],
    requiredFile: null,
    downloadUrl: null,
    whatYouLearn: [
      'How brand messaging stays consistent while platform wording changes.',
      'How to spot copy that is technically consistent but awkward for the channel.',
    ],
    questions: [
      'Which platform needed the biggest wording change?',
      'What part of the message stayed consistent across all versions?',
    ],
  },
  {
    id: 104,
    chapterId: 20,
    title: 'Campaign Calendar and Risk Review',
    question: 'Does a full campaign plan still make sense when checked for timing, repetition, and risk?',
    whatToDo: 'Build a short campaign calendar and audit it before treating it as final.',
    steps: [
      'Step 1 — Ask AI to create a 2-week campaign calendar with date, channel, content idea, CTA, and objective for each post or message.',
      'Step 2 — Audit the calendar for repetition, missing stages, unrealistic timing, unsupported claims, and weak CTAs.',
      'Step 3 — Improve at least 3 calendar entries based on your audit.',
      'Step 4 — Write a final campaign recommendation with the strongest channel, strongest message, and biggest risk.',
    ],
    requiredFile: null,
    downloadUrl: null,
    whatYouLearn: [
      'How to review a campaign calendar as a working plan instead of a list of random posts.',
      'How to identify campaign risks before publishing.',
    ],
    questions: [
      'What repeated idea did you find in the calendar?',
      'What is the biggest risk in your campaign plan?',
    ],
  },
  {
    id: 105,
    ...
    question: 'How do brand colors, fonts, and logo rules keep designs consistent?',
    whatToDo: 'Create a simple brand kit for a small business before generating any creative.',
    steps: [
      'Step 1 — Choose a business or create a fictional one.',
      'Step 2 — Define 2 brand colors, 1 heading font style, 1 body font style, and 3 brand personality words.',
      'Step 3 — Ask AI to suggest a simple brand kit and compare it with your choices.',
      'Step 4 — Finalize a one-page brand kit with colors, fonts, logo use, and tone.',
    ],
    requiredFile: null,
    downloadUrl: null,
    whatYouLearn: [
      'How a brand kit gives AI design tools useful boundaries.',
      'Why design consistency should be decided before making creatives.',
    ],
    questions: [
      'Which brand color or font choice best matched your business personality?',
      'What AI suggestion did you reject because it did not fit the brand?',
    ],
  },
  {
    id: 106,
    chapterId: 21,
    title: 'Template Adaptation Practice',
    question: 'How can one template be adapted without making every post look identical?',
    whatToDo: 'Use Canva templates to create three post variations that share the same brand identity.',
    steps: [
      'Step 1 — Pick one Canva template style for your brand.',
      'Step 2 — Create 3 versions: product announcement, customer tip, and promotional offer.',
      'Step 3 — Keep colors and fonts consistent, but change layout emphasis based on the message.',
      'Step 4 — Compare the three designs and identify what stayed consistent and what changed.',
    ],
    requiredFile: null,
    downloadUrl: null,
    whatYouLearn: [
      'How to adapt templates while preserving brand identity.',
      'Why consistency does not mean making every creative look exactly the same.',
    ],
    questions: [
      'What design element stayed consistent across all three posts?',
      'Which post needed a different layout, and why?',
    ],
  },
  {
    id: 107,
    chapterId: 21,
    title: 'Creative Readability Check',
    question: 'Does your design communicate the message in three seconds?',
    whatToDo: 'Use AI and peer review to improve readability, hierarchy, and visual focus in a social media creative.',
    steps: [
      'Step 1 — Select one design from your Canva work.',
      'Step 2 — Ask AI to review the design text and layout plan for clarity, hierarchy, and unnecessary elements.',
      'Step 3 — Show the design to a classmate for three seconds and ask what they remember.',
      'Step 4 — Revise the design so the main message is easier to notice quickly.',
    ],
    requiredFile: null,
    downloadUrl: null,
    whatYouLearn: [
      'How to test whether a creative is readable at social media speed.',
      'How visual hierarchy affects what the audience remembers first.',
    ],
    questions: [
      'What did your classmate notice first?',
      'What did you enlarge, remove, or simplify after the readability check?',
    ],
  },
  {
    id: 108,
    chapterId: 21,
    title: 'Mini Brand Creative System',
    question: 'Can you create a small set of branded creatives that look like they belong together?',
    whatToDo: 'Build a 5-piece mini creative system for one campaign using a consistent brand kit.',
    steps: [
      'Step 1 — Create five creatives: announcement post, story, offer post, educational post, and thank-you or reminder post.',
      'Step 2 — Use the same brand kit across all five.',
      'Step 3 — Ask AI to review the set for consistency, readability, tone, and platform fit.',
      'Step 4 — Write a short creative direction note explaining the rules someone else should follow to make the next post.',
    ],
    requiredFile: null,
    downloadUrl: null,
    whatYouLearn: [
      'How to turn individual Canva designs into a repeatable creative system.',
      'How to document simple brand rules for future creatives.',
    ],
    questions: [
      'Which creative felt least consistent with the set?',
      'What rule would you give another designer before they make the next post?',
    ],
  },
  {
    id: 109,
    ...
    question: 'What information does an AI image tool need to create a useful marketing visual?',
    whatToDo: 'Write and improve prompts for a simple product image or promotional poster.',
    steps: [
      'Step 1 — Choose a product and one clear promotion message.',
      'Step 2 — Write a basic image prompt with product, background, mood, format, and text requirement.',
      'Step 3 — Generate or draft two prompt variations with different styles.',
      'Step 4 — Compare which prompt gives clearer direction and fewer vague words.',
    ],
    requiredFile: null,
    downloadUrl: null,
    whatYouLearn: [
      'How product, setting, style, audience, and format affect AI image generation.',
      'Why vague visual prompts produce generic marketing images.',
    ],
    questions: [
      'Which prompt detail improved the image most?',
      'What vague word did you replace with a specific visual instruction?',
    ],
  },
  {
    id: 110,
    chapterId: 22,
    title: 'Product Poster Critique',
    question: 'How do you decide whether an AI-generated poster is publishable?',
    whatToDo: 'Evaluate an AI-generated poster for message clarity, brand fit, visual errors, and text accuracy.',
    steps: [
      'Step 1 — Generate one product poster using Canva AI, Microsoft Designer, or another image tool.',
      'Step 2 — Check the poster for spelling errors, distorted product details, unclear offer, and brand mismatch.',
      'Step 3 — Ask AI to critique the poster using those same criteria.',
      'Step 4 — Make a final decision: publish, edit, or reject.',
    ],
    requiredFile: null,
    downloadUrl: null,
    whatYouLearn: [
      'How to review AI-generated marketing visuals before using them publicly.',
      'Why visual quality, accuracy, and message clarity all matter in promotional design.',
    ],
    questions: [
      'What was the biggest visual or text problem in the poster?',
      'Would you publish it, edit it, or reject it? Why?',
    ],
  },
  {
    id: 111,
    chapterId: 22,
    title: 'Create Image Variations for Different Audiences',
    question: 'Should the same product poster look the same for every audience?',
    whatToDo: 'Generate different visual directions for the same product aimed at two audiences.',
    steps: [
      'Step 1 — Choose one product and two audiences, such as college students and working professionals.',
      'Step 2 — Write separate image prompts for each audience, changing setting, tone, colors, and message emphasis.',
      'Step 3 — Generate or draft two poster concepts.',
      'Step 4 — Explain how each concept matches its audience differently.',
    ],
    requiredFile: null,
    downloadUrl: null,
    whatYouLearn: [
      'How audience changes visual direction in marketing design.',
      'Why the same product benefit may need different visual treatment for different customers.',
    ],
    questions: [
      'What changed between the two audience versions?',
      'Which audience version felt more convincing, and why?',
    ],
  },
  {
    id: 112,
    chapterId: 22,
    title: 'Final Campaign Visual Pack',
    question: 'Can AI image generation support a small campaign without creating inconsistent visuals?',
    whatToDo: 'Create a 4-image visual pack for one campaign and audit it for consistency and publishability.',
    steps: [
      'Step 1 — Define one campaign theme, target audience, product, offer, and brand style.',
      'Step 2 — Create prompts for four visuals: launch poster, product feature image, social story, and reminder post.',
      'Step 3 — Generate or draft the four concepts and compare them as a set.',
      'Step 4 — Audit the pack for consistent colors, product accuracy, readable text, repeated mistakes, and unsupported claims.',
    ],
    requiredFile: null,
    downloadUrl: null,
    whatYouLearn: [
      'How to plan multiple AI-generated visuals as one campaign set.',
      'How to audit generated images for consistency, accuracy, and business usefulness.',
    ],
    questions: [
      'Which image in the pack felt least connected to the others?',
      'What prompt rule would you add before generating the next version?',
    ],
  },
]
